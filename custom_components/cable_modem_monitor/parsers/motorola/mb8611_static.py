...
class MotorolaMB8611StaticParser(ModemParser):
    ...
    priority = 100  ***REMOVED*** Try after HNAP parser, before generic
    ...
    def can_parse(cls, soup: BeautifulSoup, url: str, html: str) -> bool:
        ...
        ***REMOVED*** Same detection logic as HNAP parser
        return (
            "MB8611" in html
            or "MB 8611" in html
                ...
                channels.append(
                    {
                        "channel_id": int(cells[0].text.strip()),
                        "lock_status": cells[1].text.strip(),
                        "modulation": cells[2].text.strip(),  ***REMOVED*** Channel Type in HTML
                        "ch_id": int(cells[3].text.strip()),
    ...
    def _parse_system_info_from_html(self, soup: BeautifulSoup) -> dict:
        ...
        ***REMOVED*** Helper to find and store text from an element by its ID
