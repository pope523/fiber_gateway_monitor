            ...
            ***REMOVED*** Phase 2: Wait for channels to sync
            ...
            while phase2_elapsed < phase2_max_wait:
                try:
                    ...
                    ***REMOVED*** Consider fully online when:
                    ***REMOVED*** 1. Connection status is "online"
                    ***REMOVED*** 2. We have channels (not 0/0)
                    ***REMOVED*** 3. Channel counts have been stable for 2+ polls (20+ seconds)
                    if (
