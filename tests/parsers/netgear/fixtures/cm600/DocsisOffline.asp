...
<body onLoad="'MNU_menu.htm'" style="margin:0px;background-color:***REMOVED***e5e5e5">
    <form id="target" name="DocsisOffline" action='/goform/DocsisOffline' method="post" onSubmit="return false">
        ...
        <table WIDTH="100%" BORDER="0" CELLSPACING="3" CELLPADDING="0">
            <tr>
                <td colspan="2" style="background-image: url('liteblue.gif'); height: 12px;">
                    &nbsp;
                </td>
            </tr>
        </table>
        <table WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="4">
            ...
            <tr>
                <td align=center>
                    <b>
                        Please check the RF connection.
                    </b>
                </TD>
            </TR>
        </table>
        ...
        <table WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="4">
            <TR>
                <td align=center>
                    Click <b>OK</b> to go back to the Dashboard screen....
                </TD>
            </TR>
            <TR>
                <td align=center>
                    <a style="color:blue;TEXT-DECORATION :UNDERLINE" href="DocsisStatus.asp">Click <b>Here</b> to go to setting....</a>
                </TD>
            </TR>
            <TR>
                <TD align=center>
                    &nbsp;&nbsp;&nbsp;
                    <button TYPE="BUTTON" value="OK" NAME="OK" class="button-rule" onclick="buttonClick(this,'OK');location.href='DashBoard.asp'">
