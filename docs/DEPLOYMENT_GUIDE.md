***REMOVED*** Deployment Guide - Cable Modem Monitor v1.2.2

This guide will help you deploy the updated integration to your Home Assistant instance.

***REMOVED******REMOVED*** What's New in v1.2.2
...
***REMOVED******REMOVED*** Deployment Methods

***REMOVED******REMOVED******REMOVED*** Method 1: Manual Copy via File Editor (Easiest)
...
***REMOVED******REMOVED******REMOVED*** Method 2: SSH/SCP Deployment

If you have SSH access configured:

```bash
***REMOVED*** From your project directory
cd /mnt/c/Users/ken_s/OneDrive/Documents/Projects/cable_modem_monitor

***REMOVED*** Option A: Use the deployment script (requires SSH keys)
./deploy_to_ha.sh

***REMOVED*** Option B: Manual SCP
scp -r custom_components/cable_modem_monitor/* claude@192.168.5.2:/config/custom_components/cable_modem_monitor/

***REMOVED*** Restart Home Assistant
ssh claude@192.168.5.2 "ha core restart"
```

***REMOVED******REMOVED******REMOVED*** Method 3: HACS Update (Future)
...
***REMOVED******REMOVED******REMOVED*** 1. Verify Installation
...
***REMOVED******REMOVED******REMOVED*** 2. Access Diagnostics
...
***REMOVED******REMOVED******REMOVED*** 3. Clean Up Historical Zero Values
...
***REMOVED******REMOVED******REMOVED*** 4. Monitor for Future Issues
...
***REMOVED******REMOVED*** Rollback (If Needed)
...
2. Restore backup:
   ...
   ***REMOVED*** Restore the most recent
...
***REMOVED******REMOVED******REMOVED*** Integration Won't Load
...
***REMOVED******REMOVED******REMOVED*** Sensors Not Updating
...
***REMOVED******REMOVED******REMOVED*** Still Seeing Zero Values
