...
- [**Development**](***REMOVED***development) (for contributors)
...
./scripts/setup.sh    ***REMOVED*** Local Python setup
***REMOVED*** OR open in VS Code and click "Reopen in Container" for Dev Container
```
